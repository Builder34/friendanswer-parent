...
insert  into `fa_favor`(`favor_id`,`user_id`,`post_id`,`creat_time`) values (1,1,1,'2016-08-08 11:44:34'),(2,1,3,'2016-08-10 15:40:32');
...
insert  into `fa_star`(`star_id`,`user_id`,`post_id`,`star_time`) values (1,1,1,'2016-08-08 11:45:36'),(2,1,2,'2016-08-15 00:45:51');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='行业领域表';

/*Data for the table `fa_territory` */

insert  into `fa_territory`(`territory_id`,`territory_name`,`create_time`) values (1,'软件','2016-08-15 00:35:57'),(2,'金融','2016-08-15 00:36:07');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='领域分类表';

/*Data for the table `fa_territory_category` */

insert  into `fa_territory_category`(`category_id`,`category_name`,`territory_id`,`create_time`) values (1,'后端工程师',1,'2016-08-15 00:36:31'),(2,'iOS前端工程师',1,'2016-08-15 00:36:53'),(3,'高级会计师',2,'2016-08-15 00:37:24');
...
CREATE TABLE `fa_user` (
  ...
  `phone_num` varchar(30) DEFAULT NULL COMMENT 'phone_num',
  `regist_mode` int(2) DEFAULT NULL COMMENT '注册方式：0-手机注册，1-微信授权注册，2-QQ授权注册，3-微博授权注册',
  `regist_time` datetime DEFAULT NULL COMMENT '注册时间',
  `last_login_time` datetime DEFAULT NULL COMMENT '最近登录时间',
  `isOnline` int(1) DEFAULT NULL COMMENT '是否在线；0-离线，1-在线',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户表';

/*Data for the table `fa_user` */

insert  into `fa_user`(`user_id`,`nick_name`,`real_name`,`avatar_url`,`phone_num`,`regist_mode`,`regist_time`,`last_login_time`,`isOnline`) values (1,'隔壁老王34','罗成',NULL,'13450399531',0,'2016-08-15 00:44:34','2016-08-15 00:44:39',0),(2,'隔壁老宋啊','宋宝强',NULL,'13335591111',0,'2016-08-16 20:22:24','2016-08-16 20:22:26',1);

/*Table structure for table `fa_user_pwd` */

DROP TABLE IF EXISTS `fa_user_pwd`;

CREATE TABLE `fa_user_pwd` (
...
/*Data for the table `fa_user_pwd` */

/*Table structure for table `fa_user_territory` */

DROP TABLE IF EXISTS `fa_user_territory`;

CREATE TABLE `fa_user_territory` (
  `user_tid` int(11) NOT NULL AUTO_INCREMENT COMMENT '用户所属领域id',
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `category_id` int(11) DEFAULT NULL COMMENT '领域分类id',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`user_tid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户所属领域表';

/*Data for the table `fa_user_territory` */

insert  into `fa_user_territory`(`user_tid`,`user_id`,`category_id`,`create_time`) values (1,1,1,'2016-08-15 00:42:32'),(2,1,2,'2016-08-15 00:42:37');
